# @clef-sh/sops-linux-arm64

Bundled [sops](https://github.com/getsops/sops) binary for **Linux ARM64**.
...
a Linux ARM64 machine, npm automatically installs this package and Clef resolves the bundled
