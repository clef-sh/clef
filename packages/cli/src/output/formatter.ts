...
export const formatter = {
  ...
  formatDependencyError(
    err: SopsMissingError | SopsVersionError | AgeMissingError | AgeVersionError,
  ): void {
    const icon = sym("failure");
    const arrow = sym("arrow");
    const name =
      err instanceof SopsMissingError || err instanceof SopsVersionError ? "sops" : "age";

    if (err instanceof SopsMissingError || err instanceof AgeMissingError) {
